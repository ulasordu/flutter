...
void main() {
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            await const WebReleaseBundle(WebRendererMode.autoDetect,
                    isWasm: false)
                .build(environment);
...
''');
  ...
  test(
      ...
      () => testbed.run(() async {
            environment.outputDir.childDirectory('a').childFile('a.txt')
              ..createSync(recursive: true)
              ..writeAsStringSync('A');
            await WebServiceWorker(globals.fs, WebRendererMode.autoDetect,
                    isWasm: false)
                .build(environment);
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            await WebBuiltInAssets(globals.fs, isWasm: false)
                .build(environment);
