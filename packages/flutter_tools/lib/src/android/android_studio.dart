...
class AndroidStudio {
  ...
  static AndroidStudio? latestValid() {
    ...
    if (configuredStudioPath != null) {
      ...
      if (globals.platform.isMacOS &&
          !correctedConfiguredStudioPath.endsWith('Contents')) {
        correctedConfiguredStudioPath =
            globals.fs.path.join(correctedConfiguredStudioPath, 'Contents');
      }
...
''');
  ...
  static List<AndroidStudio> _allLinuxOrWindows() {
    ...
    final String? configuredStudioDir =
        globals.config.getValue('android-studio-dir') as String?;
    if (configuredStudioDir != null &&
        !alreadyFoundStudioAt(configuredStudioDir)) {
